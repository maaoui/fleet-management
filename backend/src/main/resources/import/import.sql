...
SET EXPLOATATION_REPORT_ID = 10,
    INSURANCE_ID           = 10,
    CURRENT_EMPLOYEE_ID    =10
WHERE ID = 10;
-- Updates for EMPLOYEE
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =1
WHERE ID = 1;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =2
WHERE ID = 2;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =3
WHERE ID = 3;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =4
WHERE ID = 4;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =5
WHERE ID = 5;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =6
WHERE ID = 6;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =7
WHERE ID = 7;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =8
WHERE ID = 8;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =9
WHERE ID = 9;
UPDATE EMPLOYEE
SET CURRENT_VEHICLE_ID =10
WHERE ID = 10;
