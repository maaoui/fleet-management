...
VALUES (1, 'KL1NF48J7JK00000', CURRENT_TIMESTAMP, 171, 'Opel', 'Insignia', 'WW 00001', 1851, 2016, NULL, NULL, NULL),
       (2, 'KL1NF48J7JK00002', CURRENT_TIMESTAMP, 172, 'Opel', 'Insignia', 'WW 00002', 1852, 2016, NULL, NULL, NULL),
       (3, 'KL1NF48J7JK00003', CURRENT_TIMESTAMP, 173, 'Opel', 'Insignia', 'WW 00003', 1853, 2016, NULL, NULL, NULL),
       (4, 'KL1NF48J7JK00004', CURRENT_TIMESTAMP, 174, 'Opel', 'Insignia', 'WW 00004', 1854, 2016, NULL, NULL, NULL),
       (5, 'KL1NF48J7JK00005', CURRENT_TIMESTAMP, 175, 'Opel', 'Insignia', 'WW 00005', 1855, 2016, NULL, NULL, NULL),
       (6, 'KL1NF48J7JK00006', CURRENT_TIMESTAMP, 176, 'Opel', 'Insignia', 'WW 00006', 1856, 2016, NULL, NULL, NULL),
       (7, 'KL1NF48J7JK00007', CURRENT_TIMESTAMP, 177, 'Opel', 'Insignia', 'WW 00007', 1857, 2016, NULL, NULL, NULL),
       (8, 'KL1NF48J7JK00008', CURRENT_TIMESTAMP, 178, 'Opel', 'Insignia', 'WW 00008', 1858, 2016, NULL, NULL, NULL),
       (9, 'KL1NF48J7JK00009', CURRENT_TIMESTAMP, 179, 'Opel', 'Insignia', 'WW 00009', 1859, 2016, NULL, NULL, NULL),
       (10, 'KL1NF48J7JK00010', CURRENT_TIMESTAMP, 180, 'Opel', 'Insignia', 'WW 00010', 1860, 2016, NULL, NULL, NULL);
...
VALUES (1, 'Oil change', 15000, 1, 1),
       (2, 'Oil change', 15000, 1, 2),
       (3, 'Oil change', 15000, 1, 3),
       (4, 'Oil change', 15000, 1, 4),
       (5, 'Oil change', 15000, 1, 5),
       (6, 'Oil change', 15000, 1, 6),
       (7, 'Oil change', 15000, 1, 7),
       (8, 'Oil change', 15000, 1, 8),
       (9, 'Oil change', 15000, 1, 9),
       (10, 'Oil change', 15000, 1, 10);
